 ...
 */
public class TermTokenizedSentenceIterator implements Iterator<TermTokenizedSentence> {

    List<TermTokenizedDocument> documents;
    Iterator<TermTokenizedDocument> documentIterator;
    Iterator<TermTokenizedSentence> sentenceIterator;

    //it is assumed that the document list is not empy and every document has at least one sentence
    public TermTokenizedSentenceIterator(List<TermTokenizedDocument> documents) {
    ...
    @Override
    public TermTokenizedSentence next() {
